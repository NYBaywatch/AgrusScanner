...
public class ScanConfig
{
    ...
    // AI port preset ships with the signature catalog so new services can add ports without an app release.
    public static int[] AiPorts => Services.SignatureStore.Current.AiPorts;
